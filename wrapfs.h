...
/* intialized in main.c to store mount options */
extern struct wrapfs_options wopt;

/* encryption enabled */
#define KEYLEN 16
extern const char zero_key[KEYLEN];
extern long calculate_md5(char *src, char *dest, int len);
extern int encrypt_decrypt(void *key, void *dest, const void *src, size_t len, int option);
